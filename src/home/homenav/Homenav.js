    ...
    return (
      <div className="homenav__container" key={this.props.key}>
        ...
        <div className="homenav__add_container">
          <Link
            className="homenav__add_button homenav__button"
            to={`/addnewimagepost/${this.props.categories[1]}`}
          >
            New Picture
          </Link>
          <Link
            className="homenav__add_button homenav__button"
            to={`/addnewstorypost/${this.props.categories[1]}`}
          >
            New Story
          </Link>
        </div>
        <Link
          to={`/gallery/${this.props.currentUserFamilyId}/${
            this.props.categories[1]
          }`}
          className="homenav__button"
        >
          View Posts
        </Link>
        <Link
          className="homenav__button homenav__edit"
          to={`/editcategory/${this.props.categories[1]}`}
        >
          Edit
        </Link>
      </div>
